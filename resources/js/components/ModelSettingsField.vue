    ...
    <div>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <p class="text-white-50% text-lg">
                You can edit this nova-model-settings-field's component at:
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-model-settings-fields/resources/js/components/ModelSettingsField.vue</code>
            </p>
        </card>
    </div>
</template>
